...
const char* cc3D_PositionNormalTex_malivr_vert = STRINGIFY(
...
\n#endif\n
    ...
    gl_Position = CC_MultiViewPMatrix[gl_ViewID_OVR] * ePosition;
}
);

const char* cc3D_SkinPositionNormalTex_malivr_vert = STRINGIFY(
layout(num_views = 4) in;
\n#ifdef USE_NORMAL_MAPPING\n
\n#if (MAX_DIRECTIONAL_LIGHT_NUM > 0)\n
uniform vec3 u_DirLightSourceDirection[MAX_DIRECTIONAL_LIGHT_NUM];
