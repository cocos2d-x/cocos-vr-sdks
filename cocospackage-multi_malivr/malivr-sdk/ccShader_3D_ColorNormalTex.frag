...
const char* cc3D_ColorNormalTex_malivr_frag = STRINGIFY(
...
in mediump vec3 v_dirLightDirection[MAX_DIRECTIONAL_LIGHT_NUM];
\n#endif\n
\n#endif\n
\n#if MAX_POINT_LIGHT_NUM\n
in mediump vec3 v_vertexToPointLightDirection[MAX_POINT_LIGHT_NUM];
\n#endif\n
\n#if MAX_SPOT_LIGHT_NUM\n
in mediump vec3 v_vertexToSpotLightDirection[MAX_SPOT_LIGHT_NUM];
\n#ifdef USE_NORMAL_MAPPING\n
in mediump vec3 v_spotLightDirection[MAX_SPOT_LIGHT_NUM];
\n#endif\n
\n#endif\n
...
\n#if ((MAX_DIRECTIONAL_LIGHT_NUM > 0) || (MAX_POINT_LIGHT_NUM > 0) || (MAX_SPOT_LIGHT_NUM > 0))\n
    fragColor = texture(CC_Texture0, TextureCoordOut) * u_color * combinedColor;
\n#else\n
